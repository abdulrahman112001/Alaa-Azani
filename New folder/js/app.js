...
if (
  localStorage.getItem("menuTop") !== null &&
  localStorage.getItem("menuLeft") !== null
) {
...
/*TODO: add nav-scroll class when scroll*/
...
lis.forEach(li => {
  li.onclick = function () {
    ...
    $(".dashboard .right-side").removeClass("show");
  }
});


/*TODO: testimonials swiper */
...
/*TODO: shuffle gallery section*/
$(".gallery .head li").click(function () {
  $(this).addClass("active").siblings().removeClass("active");
  if ($(this).data("class") === "all") {
    $(".gallery .gallery-card").fadeIn(1000);
  } else {
    $(".gallery .gallery-card").hide();
...
document.querySelector("#dropdown .jdropdown-container-header input").setAttribute("required", "required");
document.querySelector("#dropdown .jdropdown-container-header input").setAttribute("name", "country");
